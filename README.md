This project is a Game UI for panda.js game engine, it is an adapter between [panda.js](http://www.pandajs.net/) and [Canvas ToolKit](https://github.com/drawapp8/cantk).
